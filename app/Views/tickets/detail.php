                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <div class="meta-box">
                            ...
                            <div class="text-muted small"><?= $ticket['reporter_department'] ?></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="meta-box">
                    ...
                    <div class="col-md-4">
                        <div class="meta-box">
                            ...
                            <div class="meta-value text-primary"><?= $ticket['category_name'] ?></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow-sm card-detail h-100">
            ...
            <div class="card-body p-4 bg-white" style="border-radius: 0 0 15px 15px;">
                ...
                <div class="mb-4">
                    <label class="form-label-custom">DITUGASKAN KEPADA:</label>
                    <div class="d-flex align-items-center mt-1">
                        <?php if($ticket['technician_name']): ?>
                            ...
                            <span class="fw-bold fs-6 text-dark"><?= $ticket['technician_name'] ?></span>
                        <?php else: ?>
                ...
                <?php elseif($ticket['technician_id'] == session()->get('id') && $ticket['status'] != 'closed'): ?>
                    <form action="<?= base_url('tickets/update-status') ?>" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control shadow-sm" name="resolution_note" rows="4" placeholder="Tuliskan solusi yang dilakukan agar dapat menjadi dokumentasi..." <?= ($ticket['status'] == 'closed') ? 'readonly' : '' ?>><?= $ticket['resolution_note'] ?></textarea>
                        </div>
                    ...
                    <div class="alert <?= ($ticket['status'] == 'closed') ? 'alert-success' : 'alert-info' ?> border-0 shadow-sm mt-3">
                        <?php if($ticket['status'] == 'closed'): ?>
                            ...
                            <div class="p-2 bg-white rounded border small text-dark" style="font-style: italic;">
                                <?= $ticket['resolution_note'] ? $ticket['resolution_note'] : 'Tidak ada catatan.' ?>
                            </div>
                        <?php else: ?>
